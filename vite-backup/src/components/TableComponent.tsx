...
export default function TableComponent({
  ...
  return (
    <div className="rounded-2xl border border-[#e6eae7] dark:border-[#232a26] bg-white dark:bg-[#141816] overflow-hidden shadow-sm">
      {/* Table Header */}
      {(title || description || actions) && (
        <div className="p-5 border-b border-earth-100 dark:border-earth-900/40 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white dark:bg-[#141816]">
          <div>
