...
export default function StatCard({
  ...
  const colorSchemes = {
    ...
    default: {
      bg: 'bg-white dark:bg-[#111714]',
      iconColor: 'text-earth-500 dark:text-earth-400',
      borderColor: 'border-[#e6eae7] dark:border-primary-950/20'
    }
  };
  ...
  return (
    <div className={`p-6 rounded-2xl border ${currentColors.borderColor} ${color === 'default' ? 'bg-white dark:bg-[#111714] hover-card' : currentColors.bg} flex flex-col justify-between shadow-sm relative overflow-hidden transition-all duration-300`}>
