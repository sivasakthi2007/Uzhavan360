...
export default function OrderModal({ product, isOpen, onClose, onConfirm }: OrderModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Container */}
      <div className="relative w-full max-w-lg rounded-2xl border border-[#e6eae7] dark:border-primary-950/20 bg-white dark:bg-[#111714] shadow-2xl p-6 overflow-hidden z-10 animate-slide-up">
        {/* Header */}
        ...
        <form onSubmit={handlePlaceOrder} className="mt-5 space-y-4">
          ...
          <div className="p-4 rounded-xl border border-[#e6eae7] dark:border-primary-950/20 bg-white dark:bg-[#111714] space-y-2.5">
